...
One prompt in, one page out. The screenshots below come from the test suite
(`evals/evals.json`), generated by the skill from a three-sentence prompt
describing a webhook relay service:
